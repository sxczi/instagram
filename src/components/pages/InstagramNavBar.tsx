    ...
    render() {
        return (
            <div className="header">
                <nav>
                    <div className="logo">
                        <Link to="/" onClick={() => document.title = "Instagram"}>
                    ...
                    <div className="nav">
                        <ul>
                            ...
                            <li>
                                <Link to="/direct/inbox/" onClick={() => document.title = "Inbox • Direct"}>
                            ...
                            <li>
                                <Link to="/explore/" onClick={() => document.title = "Instagram"}>
                            ...
                            <li>
                                <Link to="/accounts/activity/" onClick={() => document.title = "Instagram"}>
                            ...
                            <li>
                                <Link to="/profile/" onClick={() => document.title = "user (@user) • Instagram"}>
                                    <img src="./pfp.jpg" alt="" draggable="false" />
                                </Link>
                            </li>
                        </ul>
                    </div>

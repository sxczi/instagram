...
class Saved extends React.Component {
    componentDidMount() {
        ...
        (document.getElementById("saved")?.querySelector("svg") as SVGElement).setAttribute("fill", "#262626");
        (document.getElementById("saved")?.querySelector("span") as HTMLSpanElement).classList.add("link");
        (document.getElementById("saved") as HTMLUListElement).style.borderTop = "1px solid black";
    }

...
class Channel extends React.Component {
    componentDidMount() {
        ...
        (document.getElementById("channel")?.querySelector("svg") as SVGElement).setAttribute("fill", "#262626");
        (document.getElementById("channel")?.querySelector("span") as HTMLSpanElement).classList.add("link");
        (document.getElementById("channel") as HTMLUListElement).style.borderTop = "1px solid black";
    }
